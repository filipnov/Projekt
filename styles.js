...
export default StyleSheet.create({
  ...
  loginScrollContent: {
    ...
    alignItems: "center",
    justifyContent: "center",
    paddingHorizontal: Math.round(clamp(ms(18), 16, 24)),
    paddingTop: Math.round(clamp(vs(28), 20, 44)),
    paddingBottom: Math.round(clamp(vs(28), 22, 40)),
  },
  loginHero: {
    width: "100%",
    maxWidth: 390,
    alignItems: "center",
    marginBottom: Math.round(clamp(vs(16), 12, 22)),
  },
  loginLogo: {
    width: Math.round(clamp(SCREEN_WIDTH * 0.38, 126, 174)),
    height: Math.round(clamp(SCREEN_WIDTH * 0.38, 126, 174)),
    borderRadius: Math.round(clamp(ms(24), 18, 30)),
    marginBottom: Math.round(clamp(vs(16), 10, 20)),
  },
  loginHeroTitle: {
    fontSize: Math.round(clamp(ms(30), 26, 34)),
    fontWeight: "900",
    color: "#111827",
    textAlign: "center",
  },
  ...
  loginTextInput: {
    width: "100%",
    minHeight: Math.round(clamp(vs(52), 48, 58)),
    borderRadius: Math.round(clamp(ms(14), 12, 16)),
    borderWidth: 1,
    borderColor: "#d1d5db",
  ...
  loginForgotText: {
    fontSize: Math.round(clamp(ms(14), 13, 16)),
    fontWeight: "800",
    color: "#25632f",
    textDecorationLine: "underline",
  },
  loginPrimaryButton: {
    width: "100%",
    minHeight: Math.round(clamp(vs(54), 50, 60)),
    alignItems: "center",
    justifyContent: "center",
    borderRadius: Math.round(clamp(ms(14), 12, 16)),
    backgroundColor: COLORS.buttonColor,
  ...
  loginDividerRow: {
    ...
    alignItems: "center",
    gap: 12,
    marginVertical: Math.round(clamp(vs(16), 12, 20)),
  },
  loginDividerLine: {
    flex: 1,
    height: 1,
  ...
  loginSecondaryButton: {
    width: "100%",
    minHeight: Math.round(clamp(vs(50), 46, 56)),
    alignItems: "center",
    justifyContent: "center",
    borderRadius: Math.round(clamp(ms(14), 12, 16)),
    borderWidth: 1,
  ...
  loginSecondaryButtonPressed: {
    backgroundColor: "#e6f5e9",
  },
  loginSecondaryButtonText: {
    color: COLORS.buttonColor,
    fontSize: Math.round(clamp(ms(17), 15, 19)),
    fontWeight: "900",
  },
  ...
  screenBackButtonPressed: {
    opacity: 0.8,
    transform: [{ scale: 0.96 }],
  },
  screenBackButtonImage: {
    width: 52,
    height: 52,
  },
  productSearchBackground: {
    flex: 1,
    backgroundColor: "#edf7ef",
  },
  productSearchBackgroundBand: {
    height: "32%",
    backgroundColor: "#d8f0dc",
    borderBottomLeftRadius: 34,
    borderBottomRightRadius: 34,
  },
  productSearchKeyboardArea: {
    position: "absolute",
    top: 128,
    left: 0,
    right: 0,
  ...
  productSearchImagePlaceholderText: {
    fontSize: 20,
    fontWeight: "800",
    color: "#6b7280",
  },
  productSearchResultTextBox: {
    width: "100%",
    marginTop: 8,
    alignItems: "center",
  },
  productSearchResultName: {
    fontSize: 15,
    fontWeight: "800",
    color: "#111827",
    textAlign: "center",
