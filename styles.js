...
export default StyleSheet.create({
  ...
  authTitleText: {
    ...
    marginBottom: Math.round(clamp(vs(15), 10, 18)),
     marginTop: Math.round(clamp(vs(15), 10, 18)),
    fontSize: 35
  },
  authInfoLabel: {
    ...label,
  ...
  loginGoogleIcon: {
    width: Math.round(clamp(ms(28), 24, 30)),
    height: Math.round(clamp(ms(28), 24, 30)),
    borderRadius: Math.round(clamp(ms(14), 12, 15)),
    alignItems: "center",
    justifyContent: "center",
  ...
  registerScrollContent: {
    ...
    alignItems: "center",
    paddingHorizontal: Math.round(clamp(ms(18), 16, 24)),
    paddingTop: Math.round(clamp(vs(24), 18, 34)),
    paddingBottom: Math.round(clamp(vs(28), 22, 40)),
  },
  registerHero: {
    width: "100%",
    maxWidth: 390,
    alignItems: "center",
    marginBottom: Math.round(clamp(vs(12), 8, 18)),
  },
  registerLogo: {
    width: Math.round(clamp(SCREEN_WIDTH * 0.28, 98, 138)),
    height: Math.round(clamp(SCREEN_WIDTH * 0.28, 98, 138)),
    borderRadius: Math.round(clamp(ms(20), 16, 24)),
    marginBottom: Math.round(clamp(vs(12), 8, 16)),
  },
  registerCard: {
    width: "100%",
    maxWidth: 390,
    ...
    borderRadius: Math.round(clamp(ms(20), 16, 24)),
    paddingHorizontal: Math.round(clamp(ms(20), 16, 24)),
    paddingVertical: Math.round(clamp(vs(18), 14, 24)),
    borderWidth: 1,
    borderColor: "#dfe9e2",
    shadowColor: COLORS.black,
    shadowOpacity: 0.12,
  ...
  registerConsentRow: {
    ...
    gap: 10,
    marginTop: Math.round(clamp(vs(14), 10, 18)),
  ...
  registerConsentText: {
    ...
    fontSize: Math.round(clamp(ms(12), 11, 14)),
    fontWeight: "600",
    lineHeight: Math.round(clamp(ms(18), 16, 20)),
  },
  registerBackButton: {
    marginTop: Math.round(clamp(vs(12), 10, 16)),
  },
