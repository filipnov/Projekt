...
export default StyleSheet.create({
  ...
  dashNavBar_tabs: {
    ...
    width: Math.round(clamp(s(69.5), 57, 83)),
  ...
  dashNavBar_tab_Add: {
    height: Math.round(clamp(vs(80), 68, 94)),
    width: Math.round(clamp(s(82.5), 70, 96)),
    alignItems: "center",
    flexDirection: "column",
    justifyContent: "center",
  ...
  dashNavBar_img: {
    width: Math.round(clamp(ms(30), 24, 36)),
    height: Math.round(clamp(ms(30), 24, 36)),
  },
  dashNavBar_Add: {
  ...
  dashNavBar_Add_container: {
    width: Math.round(clamp(ms(45), 38, 54)),
    height: Math.round(clamp(ms(45), 38, 54)),
    backgroundColor: "hsla(129, 56%, 43%, 1)",
  ...
  dashNavBar_text_Add: {
    fontSize: Math.round(clamp(ms(15), 13, 18)),
    fontWeight: "900",
    color: "black",
  },
});
