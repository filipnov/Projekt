      ...
      <View style={styles.windowContainer}>
        {loading ? (
          ...
          <>
            ...
            <View style={styles.nutritionRow}>
              <Text style={styles.label}>Kalórie</Text>
            ...
            <View style={styles.nutritionRow}>
              <Text style={styles.label}>Bielkoviny</Text>
              <Text style={styles.value}>
                {isPer100g
            ...
            <View style={styles.nutritionRow}>
              <Text style={styles.label}>Sacharidy</Text>
              <Text style={styles.value}>
                {isPer100g
                  ? `${product.carbs ?? "N/A"} g`
            ...
            <View style={styles.nutritionRow}>
              <Text style={styles.label}>Tuky</Text>
              <Text style={styles.value}>
                {" "}
                {isPer100g
                  ? `${product.fat ?? "N/A"} g`
            ...
            <View style={styles.nutritionRow}>
              <Text style={styles.label}>Vlákniny</Text>
              <Text style={styles.value}>
                {isPer100g
                  ? `${product.fiber ?? "N/A"} g`
            ...
            <View style={styles.nutritionRow}>
              <Text style={styles.label}>Cukry</Text>
              <Text style={styles.value}>
                {isPer100g
                  ? `${product.sugar ?? "N/A"} g`
            ...
            <View style={styles.nutritionRow}>
              <Text style={styles.label}>Soľ</Text>
              <Text style={styles.value}>
                {isPer100g
                  ? `${product.salt ?? "N/A"} g`
